  ...
  data() {
    return {
      ...
      announcements: [
        {
          content:
            "Remember, you save 5% if you keep $20 or more in your account."
        },
        {
          content:
            "Help us restock! But please, don't put boxes where they don't go."
        },
        {
          content:
            "Chez Betty is in a critical amount of debt at the moment. If items are currently unstocked, it is because we are unable to buy new items until the debt is under $2000."
        }
      ]
    };
  },
